...
I have hands-on experience with React, JavaScript, and TypeScript from frontend
work, but I'm newer to Python. I'm using this course to get more practice with
Python specifically, so I'd rather take a Python/backend issue over a
frontend/JS one even if both are otherwise similar in fit.
